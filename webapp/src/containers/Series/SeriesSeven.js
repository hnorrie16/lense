...
import { Modal, Form, Col, Row, Dropdown, DropdownButton} from "react-bootstrap";
import { FormGroup, Icon, TextareaAutosize, TextField } from '@material-ui/core'
            ...
            <div className={classes.Container}> 
                ...
                components={{
                  Action: props => (       
                    ...
                    <Dropdown.Menu>
                      <Dropdown.Item onClick={(event) => handleShow(props.data, "ADD_A")}>
                        Add above
                      </Dropdown.Item>
                      <Dropdown.Item onClick={(event) => handleShow(props.data, "ADD_B")}>
                      Add below
                      </Dropdown.Item>
                ...
                columns={[
                    ...
                    { title: 'Description', field: 'Description', cellStyle: { cellWidth: '15%', backgroundColor: '#039be5',
                    color: '#FFF' }},
